...
HistoryKind = Literal["classic", "free", "legacy"]
...
ReadingStyle = Literal["soft", "psychological", "practical", "normal_ai", "predictor"]
QuestionTopic = Literal["love", "career", "money", "decision", "self", "general"]


@dataclass(slots=True)
class HistoryListItem:
    """Одна строка в списке «История» (классика, свободный расклад или старая запись)."""
